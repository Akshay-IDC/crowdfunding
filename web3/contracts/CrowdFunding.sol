...
// import "@thirdweb-dev/contracts/extension/CrowdFunding.sol";
contract CrowdFunding {
   ...
   function donateToCampaign(uint256 _id) public payable{
       ...
       if(sent){
           campaign.amountCollections=campaign.amountCollections+amount;
       }
   }
